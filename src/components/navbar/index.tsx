...
import { Container, TitleNavBar, TitlesFilter, ListElements, Box, Input, Button } from "./style" 
...
export const NavBar = () => {
    ...
    return (
        <Container isClosed={isClosed}>
            <TitleNavBar>
                <span>Filtro</span>
                <AiOutlineClose style={{cursor: "pointer"}} onClick={() => {setIsClosed(!isClosed)}}/>
            </TitleNavBar>
            ...
            <Box>
                <Button onClick={() => {setIsClosed(!isClosed)}}>Ver anúncios</Button>
            </Box>
        </Container>
    )
}