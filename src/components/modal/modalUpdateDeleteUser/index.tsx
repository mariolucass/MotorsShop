        ...
        <ModalGeneral>
            <Container>
                ...
                <Form onSubmit={handleSubmit(onSubmit)}>
                    <Input label="Nome" name="name" width="100%" placeholder="Nome completo" register={register}/>
                    <Input label="Email" name="email" width="100%" placeholder="Email" register={register}/>
                    {/* <Input label="Senha" name="password" width="100%" placeholder="Senha" register={register}/> */}
                    <Input label="CPF" name="cpf" width="100%" placeholder="000.000.000-00" register={register}/>
                    <Input label="Celular" name="phone" width="100%" placeholder="(00) 00000-0000" register={register}/>
                    <Input label="Data de Nascimento" name="birthdate" width="100%" placeholder="DD/MM/AAAA" register={register}/>
                    ...
                    <Buttons>
                        ...
                        <Button variant="contained" id="delete" onClick={() => {deleteUserId()}}>Excluir</Button>
